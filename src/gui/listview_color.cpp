...
{
    LPCTSTR json = LR"tw(
<Window title="颜色配置" size="380,300">
    <Resource>
    ...
    <Root>
        <Vertical padding="15,15,15,15">
            <Horizontal padding="5,5,5,5">
                ...
                <Control width="5" />
                <Vertical width="40">
                    <Button name="fg5" text="前景" /> <Button name="bg5" text="背景" />
                </Vertical>
            </Horizontal>
            <Horizontal padding="5,5,5,5">
                ...
                <Control width="5" />
                <Vertical width="40">
                    <Button name="fg4" text="前景" /> <Button name="bg4" text="背景" />
                </Vertical>
            </Horizontal>
            <Horizontal padding="5,5,5,5">
                ...
                <Control width="5" />
                <Vertical width="40">
                    <Button name="fg3" text="前景" /> <Button name="bg3" text="背景" />
                </Vertical>
            </Horizontal>
            <Horizontal padding="5,5,5,5">
                ...
                <Control width="5" />
                <Vertical width="40">
                    <Button name="fg2" text="前景" /> <Button name="bg2" text="背景" />
                </Vertical>
            </Horizontal>
            <Horizontal padding="5,5,5,5">
                ...
                <Control width="5" />
                <Vertical width="40">
                    <Button name="fg1" text="前景" /> <Button name="bg1" text="背景" />
                </Vertical>
            </Horizontal>
        </Vertical>
    </Root>
